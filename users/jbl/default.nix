...
let
  ...
  fingerprint_portable_usbc = "";
  ...
  home-manager.users.jbl = { suites, ... }: {
    ...
    programs.autorandr = {
      ...
      profiles = {
        ...
        ## setup for the big one at home, the portable screen and the laptop
        "triple-screen-for" = {
          fingerprint = { "eDP1" = fingerprint_internal; "HDMI1" = fingerprint_dell_for; "DP1" = fingerprint_portable_usbc; };
          config."eDP1" = { enable = false; primary = false; position = "960x1080"; mode = "1920x1080"; };
          config."HDMI1" = { enable = true; primary = true; position = "0x0"; mode = "1920x1080"; };
          config."DP1" = { enable = true; primary = false; position = "1920x0"; mode = "1920x1080"; };
        };
      };
    };
  };
